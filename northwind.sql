...
CREATE TABLE employees (
    ...
    CONSTRAINT fk_employees_employees FOREIGN KEY (reportsto) REFERENCES employees(reportsto)
);
...
CREATE TABLE orders (
    ...
    CONSTRAINT fk_orders_shippers FOREIGN KEY (shipvia) REFERENCES shippers(shipvia)
);
